            ...
            <main className="relative">
                ...
                <section id='about' className='w-full mt-10 bg-gray-100'>
                    <div className='w-full h-[90px] lg:h-[125px] bg-[#131313] flex flex-row justify-center items-center'>
                        <h1 className='text-[#FED685] font-bugetaDream text-3xl sm:text-4xl md:text-5xl xl:text-6xl uppercase mt-4 transition-all ease-in-out'>About Us</h1>
                    </div>
                    
                    <div className='px-8 py-10 xs:px-16 lg:px-24 xl:px-28 2xl:px-44 flex flex-col items-center'>
                        <div>
                            <h2 className='text-3xl sm:text-4xl md:text-5xl font-megante text-gray-800 mb-6'>Welcome to Silverleaf Indus</h2>
                            <p className='text-gray-600 text-lg sm:text-xl font-saudagar leading-8 mb-4'>
                            ...
                            <p className='text-gray-600 text-lg sm:text-xl font-saudagar leading-8'>
                            ...
                            <div className='w-full flex flex-col lg:flex-row justify-evenly items-center mt-10 lg:mt-20 gap-10'>
                                ...
                                <NavLink onClick={handleProductClick} className='font-megante px-10 py-4 bg-[#131313] border-2 border-[#131313] text-[#FED685] hover:bg-transparent hover:text-[#131313] transition-all ease-in-out capitalize hover:cursor-pointer'>shop now</NavLink>
                            </div>
                        </div>
                        ...
                        <div>
                            <h2 className='text-3xl sm:text-4xl md:text-5xl font-megante text-gray-800 mb-6 mt-10 md:mt-20 capitalize'>meet the team</h2>
                            <p className='text-gray-600 text-lg sm:text-xl font-saudagar leading-8 mb-4'>
                            ...
                            <div className="py-10 lg:px-24 xl:px-28 2xl:px-44">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mt-10 w-full xl:max-w-4xl 2xl:max-w-5xl">
