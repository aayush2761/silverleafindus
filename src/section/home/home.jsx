            ...
            <main className="relative">
                <div id='home' className="relative w-full h-[70vh]">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center px-5 mt-14">
                        <motion.h1 className="w-full text-amber-50 text-center text-5xl sm:text-6xl md:text-7xl 2xl:text-8xl font-bugetaDream" initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} >
                            SilverLeaf Indus
                        </motion.h1>

                        <motion.h2 className="w-full text-amber-100 text-center text-lg sm:text-xl md:text-2xl 2xl:text-3xl font-saudagar mt-4" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }} >
                ...
                <section className="relative w-full h-[50px] md:h-[50px] lg:h-[60px] 2xl:h-[60px] bg-[#131313] flex justify-center items-center overflow-hidden transition-all ease-in-out">
                    <div className="absolute flex animate-marquee">
                        {Array(250).fill(bannerWords).flat().map((word, index) => (
                            <div key={index} className="text-amber-100 text-xl sm:text-2xl md:text-3xl font-saudagar px-5 py-2 uppercase transition-all ease-in-out">
                                {word}
                            </div>
                        ))}
                    </div>
                ...
                <section id="products" className="w-full h-auto pt-10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5 }} viewport={{ once: true, amount: 0.3 }} >
                    <h1 className="font-bugetaDream text-[#131313] text-center text-3xl sm:text-4xl md:text-5xl capitalize">
                        Our Products
                    </h1>
                    ...
                    <div className="flex flex-wrap justify-center mt-10 gap-10">
                        {ProductDetails.map((product) => (
                            <div key={product.productID} className="bg-white h-fit w-full xs:w-[80%] sm:w-[70%] md:w-[40%] max-w-[350px] shadow-lg" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true, amount: 0.2 }} >
                                <Link to={`/product/${product.productID}`} className="relative overflow-hidden block">
                ...
                <section id="about" className="w-full mt-10" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true, amount: 0.3 }} >
                    <div className="w-full h-[90px] bg-[#131313] flex flex-row justify-center items-center">
                        <h1 className="text-[#FED685] font-bugetaDream text-3xl sm:text-4xl md:text-5xl uppercase mt-4">
                            About Us
                        </h1>
                    </div>
                    ...
                    <motion.div className="px-8 py-10 xs:px-16 lg:px-24 xl:px-28 2xl:px-44 flex flex-col items-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} >
                        <motion.h2 className="text-3xl sm:text-4xl font-megante text-gray-800 mb-6"  initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} >
                            Welcome to Silverleaf Indus
                        </motion.h2>
                        <motion.p className="text-gray-600 text-lg sm:text-md font-saudagar leading-8 mb-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} >
                        ...
                        <motion.p className="text-gray-600 text-lg sm:text-md font-saudagar leading-8 mb-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} >
                        ...
                        <motion.p className="text-gray-600 text-lg sm:text-md font-saudagar leading-8" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} >
                        ...
                        <div className="w-full flex flex-col lg:flex-row justify-evenly items-center mt-10 lg:mt-20 gap-10">
                            ...
                            <NavLink onClick={handleProductClick} className="font-megante px-10 py-4 bg-[#131313] border-2 border-[#131313] text-[#FED685] hover:bg-transparent hover:text-[#131313] transition-all ease-in-out capitalize hover:cursor-pointer" >
                                Shop Now
                            </NavLink>
                        </div>
                    </motion.div>
                ...
                <section id="team" className="w-full" >
                    <motion.div className="px-8 py-10 xs:px-16 lg:px-24 xl:px-28 2xl:px-44 flex flex-col items-center">
                        <motion.h2 className="text-3xl sm:text-4xl font-megante text-gray-800 mb-6 mt-10 md:mt-20 capitalize" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} >
                            Meet the Team
                        </motion.h2>
